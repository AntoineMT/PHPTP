...
<html lang="en">
	...
	<body>
		...
		<header id="header">
                    ...
                    $req = "SELECT a.id,a.title,a.contente,a.image,u.username FROM article a LEFT JOIN user u ON u.id=a.author  where u.id = '$user' ORDER BY id DESC"; 
...
?>
    ...
    <a class="list-group-item list-group-item-action" href ="modif_post.php?annonce=';?> <?php echo $ligne["id"];?>"><?php print_r($ligne['title'])?> <?php echo'</h4>
                                                ';
    ?></a><?php
                                                    $ligne = $result->fetch(PDO::FETCH_ASSOC);
                                                }
...
<div class="list-group">
    <a class="list-group-item list-group-item-action" href ="blog-post.php?annonce= <?php echo $ligne["id"];?>"><?php print_r($ligne['title'])?></a>
</div>
					</div>
<!--                                    
